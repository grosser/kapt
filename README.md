...
curl -sSfL --retry 3 https://github.com/grosser/kapt/releases/download/v0.4.1/kapt-v0.4.1-$(uname -s | tr A-Z a-z)-$(uname -m | sed -e s/x86_64/amd64/ -e s/aarch64/arm64/).tar.gz | tar -zx && chmod +x kapt
